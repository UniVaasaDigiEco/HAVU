...
if ($message_id < 1 || !in_array($mark_as, ['resolved', 'unresolved'], true)) {
    $_SESSION['flash_messages'][] = [
        'type' => 'error',
        'code' => 0,
...
try {
    SystemAdminMessageCenter::setResolvedState($message_id, $mark_as === 'resolved');
    $_SESSION['flash_messages'][] = [
        'type' => 'success',
        'code' => 0,
        'message' => $mark_as === 'resolved' ? 'Message marked as resolved.' : 'Message marked as unresolved.',
    ];
} catch (Exception $e) {
    $_SESSION['flash_messages'][] = [
        'type' => 'error',
