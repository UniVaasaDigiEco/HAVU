...
return [
    ...
    'admin_route_statistics' => [
        ...
        'intro' => 'Tälle sivulle kootaan myöhemmin reittikohtaiset tilastot pelaamisesta ja suorittamisesta.',
        'placeholder' => 'Tilastosivu on vielä rakenteilla. Lisätään tähän myöhemmin esimerkiksi pelaajamäärät, valmistumisprosentit ja keskimäärin suoritetut rastit.',
    ],
    'route_editor' => [
