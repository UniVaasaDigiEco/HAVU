...
return [
    ...
    'admin_route_statistics' => [
        ...
        'intro' => 'Här kommer senare ruttvisa statistikuppgifter om spelande och genomförande att samlas.',
        'placeholder' => 'Statistiksidan är fortfarande under uppbyggnad. Senare kan den visa till exempel antal spelare, slutförandegrader och genomsnittligt antal genomförda kontrollpunkter.',
    ],
    'route_editor' => [
